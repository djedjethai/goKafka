...
const (
	...
	connectToAll  string = "kafka-1:19092,kafka-2:29092,kafka-3:39092"
	registryAddr  string = "http://schema-registry-1:8081"
	registryAddr2 string = "http://schema-registry-2:8082"
...
func producer(topic string) {
	...
	schemaRegistryClient := srclient.CreateSchemaRegistryClient(registryAddr)
	...
	if schema == nil {
		// var b bool = false
		// TODO here it can not read the schemafile.....
	...
	fmt.Println("start producer-api on port 3000... !!")
...
func consumer(topic string) {
	...
	schemaRegistryClient := srclient.CreateSchemaRegistryClient(registryAddr2)
