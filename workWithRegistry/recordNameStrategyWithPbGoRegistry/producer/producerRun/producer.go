...
func main() {
	...
	for {
		...
		offset, err := producer.ProduceMessage(pax, topic, subjectPerson)
		if err != nil {
			log.Println("Error producing Message: ", err)
		}

		log.Println("Message person produced, offset is: ", offset)

		offset, err = producer.ProduceMessage(addr, topic, subjectAddress)
		if err != nil {
			log.Println("Error producing Message: ", err)
		}

		log.Println("Message message produced, offset is: ", offset)
