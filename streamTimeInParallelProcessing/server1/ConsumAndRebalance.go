...
var list = []Data{
	Data{Key: "1", Name: "1Paul"},
	Data{Key: "1", Name: "1Celine"},
	Data{Key: "1", Name: "1Alice"},
	Data{Key: "1", Name: "1Berni"},
	Data{Key: "2", Name: "2Simon"},
	Data{Key: "1", Name: "1Paulux"},
	Data{Key: "1", Name: "1Larry"},
	Data{Key: "2", Name: "2Annie"},
	Data{Key: "1", Name: "1Zoe"},
	Data{Key: "1", Name: "1Charles"},
	Data{Key: "2", Name: "2Artur"},
}
...
func producerRedirect(topic string, dataToTransfert chan Data, partition int32) {
	...
	for dt := range dataToTransfert {
		...
		producer.Produce(&kafka.Message{
			...
			Key:       []byte(key),
			Value:     recordValue,
			Timestamp: dt.Ts, // when re-publish keep the same timestamp as before
		}, nil)
...
func consumer(topic string, toSrv4, toSrv3 chan Data) {
	...
	fmt.Println("see the topic: ", topic)
